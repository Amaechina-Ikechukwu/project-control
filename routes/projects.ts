...
projectRouter.post("/createproject/:name", async (req, res) => {
  try {
...
projectRouter.get("/getpaidstatus/:id", async (req, res) => {
  try {
    const { id } = req.params;
...
projectRouter.post("/setpaidtofalse/:id", async (req, res) => {
  try {
    const { id } = req.params;
...
projectRouter.post("/setpaidtotrue/:id", async (req, res) => {
  try {
    const { id } = req.params;
...
projectRouter.get("/getprojectid/:name", async (req, res) => {
  try {
    const { name } = req.params;
